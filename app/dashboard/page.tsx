            ...
            <div className="max-w-7xl mx-auto space-y-8">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-indigo-600/80 font-medium mt-2 text-lg">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Tabs value={viewMode} onValueChange={(v) => setViewMode(v as 'grid' | 'list')} className="hidden sm:block">
                            <TabsList className="grid w-[100px] grid-cols-2 bg-white border border-indigo-100 shadow-sm">
                                <TabsTrigger value="grid" className="data-[state=active]:bg-indigo-50 data-[state=active]:text-indigo-600">
                                    <LayoutGrid className="h-4 w-4" />
                                </TabsTrigger>
                                <TabsTrigger value="list" className="data-[state=active]:bg-indigo-50 data-[state=active]:text-indigo-600">
                        ...
                        <Link href="/upload">
                            <Button className="bg-white text-indigo-600 hover:bg-white/90 border border-indigo-100 shadow-sm gap-2 font-semibold">
                ...
                <div className="flex flex-col space-y-6">
                    {candidates.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-20 border rounded-3xl bg-white/50 border-dashed border-indigo-200">
                            <p className="text-indigo-400 mb-4 font-medium">Chưa có dữ liệu ứng viên.</p>
                            <Link href="/upload">
                                <Button className="bg-indigo-600 hover:bg-indigo-700 shadow-md shadow-indigo-200">Upload ngay</Button>
                            </Link>
                        </div>
                    )}
                </div>
